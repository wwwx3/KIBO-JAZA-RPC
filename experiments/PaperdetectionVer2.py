...
for image_path in image_paths :
    ...
    #This verision of the code results in all contours on the mask 2 without landing on mask1 
    #Some how i awas able to combime the 2 masls
    ...
    Contour 1 couldnt be read for wraping image , so what we'll do is , we'll check the x,y points for image wrapping.
